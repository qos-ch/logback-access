...
public class StatisticalViewImpl implements StatisticalView, LifeCycle {
    ...
    ch.qos.logback.access.common.filter.StatsByMinute statsByMinute = new StatsByMinute();
    StatsByHour statsByHour = new StatsByHour();
    StatsByDay statsByDay = new StatsByDay();
    StatsByWeek statsByWeek = new ch.qos.logback.access.common.filter.StatsByWeek();
